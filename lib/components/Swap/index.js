...
export function Swap(props) {
    ...
    if (props.uri !== state.uri && !state.transition) {
        ...
        setState(Object.assign(Object.assign(Object.assign({}, state), children), { index: state.index + 1, transition: createTransition(Object.assign(Object.assign({}, children), { childRef: props.children ? createRef() : null, effect: props.effect || defaultEffect, lastChildRef: state.child ? createRef() : null })), uri: props.uri }));
    }
