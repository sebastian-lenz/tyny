...
export class Picture extends View {
    constructor(options = {}) {
        ...
        this.loadMode = 2 /* LoadMode.Visibility */;
        this.nextImage = null;
        this.progress = 0;
    ...
    load() {
        this.loadMode = 0 /* LoadMode.Always */;
    ...
    setLoadMode(value) {
        if (this.loadMode === value)
            return;
        this.loadMode = value;
        if (value === 2 /* LoadMode.Visibility */) {
            this.updateImage();
        }
    }
    setVisible(value) {
    ...
    allowLoad() {
        if (this.loadMode === 2 /* LoadMode.Visibility */) {
            return this.isVisible;
        }
        return this.loadMode === 0 /* LoadMode.Always */;
    }
