...
import { cloneElement, createElement, createRef } from 'preact';
import { useLayoutEffect, useState } from 'preact/hooks';
import { dissolve } from './effects/dissolve';
import { createTransition, } from './createTransition';
const defaultEffect = dissolve();
export function Swap(_a) {
    var { childProps, children, effect, pageClassName, tagName = 'div', uri } = _a, props = __rest(_a, ["childProps", "children", "effect", "pageClassName", "tagName", "uri"]);
    ...
    return createElement(tagName, Object.assign(Object.assign({}, props), { ref: state.rootRef }), elements);
}
