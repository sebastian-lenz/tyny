...
export class ColumnPacking {
    constructor({ columnCount, gutter = 0 }) {
        this.gutter = 0;
        this.columns = [];
        this.columnWidth = 0;
        this.height = 0;
    ...
    getMaxHeight() {
        ...
        const height = columns.reduce((height, column) => Math.max(height, column.getMaxHeight()), 0);
