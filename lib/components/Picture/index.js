...
export function Picture(_a) {
    ...
    return (_jsxs("picture", Object.assign({}, props, { className: cx(PictureView.prototype.component.className, className), "data-focus-x": focusX, "data-focus-y": focusY }, { children: [_jsx("canvas", {}, void 0), sources.map((source, index) => (_createElement("source", Object.assign({}, source, { key: index }))))] }), void 0));
}
