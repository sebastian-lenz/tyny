...
export function ImageCrop(_a) {
    ...
    return (_jsx("div", Object.assign({ class: cx(ImageCropView.prototype.component.className, className), "data-focus-x": focusX, "data-focus-y": focusY, "data-mode": mode }, { children: _jsx(Image, Object.assign({}, props)) })));
}
